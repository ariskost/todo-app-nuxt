        ...
        <form @submit.prevent="addNewTask" class="flex flex-col">
            ...
            <div class="flex items-center">
                <input
                    ...
                    class="flex-1 p-3 mt-1 bg-transparent border-0 border-b-2 border-gray-300 focus:outline-none focus:border-black italic placeholder-gray-400"
                />
                <select
                    v-model="category"
                    class="w-1/3 p-4  bg-transparent border-l-2 border-0 border-b-2 border-gray-300 focus:outline-none focus:border-black italic"
                >
