...
const categories = ref(['Personal', 'Work']) // Example categories
const selectedCategories = ref([...categories.value]) // Initially all categories selected
...
onMounted(() => {
    emit('updateCategories', [...categories.value]) // Emit all categories as selected on load
    console.log('Initial Selected Categories Emitted:', [...categories.value]) // Debug log
})
